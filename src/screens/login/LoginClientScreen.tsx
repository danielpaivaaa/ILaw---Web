...
export default function LoginLawyer() {
  ...
  return (
    <div className="login-container">
      ...
      <h1 className="login-title">Em busca de Advogados?</h1>
      <p className="login-subtitle">Efetue seu login</p>
        ...
        <div className="input-group">
          ...
          <div className="input-group">
            ...
            <label htmlFor="senha" onClick={() => navigate("/home-client")}>Senha</label>

            <div className="login-footer">
              <button className="login-button">Acessar</button>
              <p className="textt">Não possui conta?<span className="cadastre-link" onClick={() => navigate("/register-client")}> Cadastre-se</span></p>
            </div>
          </div>
      </div>
  );
